...
fn init_bundle(map_length: u32, map_depth: u32, sector_resolution: u32) {
	let _ = FlowFieldTilesBundle::new(map_length, map_depth, sector_resolution);
}
...
pub fn criterion_benchmark(c: &mut Criterion) {
	...
	group.bench_function("init_bundle", |b| {
		b.iter(|| init_bundle(black_box(1000), black_box(1000), black_box(10)))
	});
	group.finish();
}
